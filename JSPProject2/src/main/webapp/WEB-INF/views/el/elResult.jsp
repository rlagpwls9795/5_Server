...
<body>
	...
	<h4>파라미터</h4>
	<pre>
	EL로 request에 세팅된 파라미터를 얻어 오는 방법
	\${param.name속성값}
	+ 데이터 파싱(String->int)도 자동으로 됨
	</pre>
	...
	* list4 : null도 아니고 요소도 한 개 추가되어 있음
	...
	--> EL은 List에 존재하는 요소를 얻어올 때 배열처럼 [index번호]를 입력해서 얻어 온다.
	</pre>
