...
<body>
	param.lang : 파라미터 중 lang의 값을 얻어 와 출력 <br>
				 단, lang이라는 이름의 파라미터가 여러 개면 첫 번째만 얻어 온다
	<br> <br>
	
	paramValues.lang : lang이라는 이름의 파라미터를 모두 얻어 와 배열로 반환 <br> <br>
		
	${param.lang} / ${paramValues.lang[0]} / ${paramValues.lang[1]} / ${paramValues.lang[2]}
