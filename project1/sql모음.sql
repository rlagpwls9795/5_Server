...
COMMENT ON COLUMN "BOARD"."B_UPDATE_DATE" IS '마지막 수정일(수정 시 업데이트)';
...
CREATE SEQUENCE SEQ_IMG_NO NOCACHE; --게시글이미지번호
CREATE SEQUENCE SEQ_COMMENT_NO NOCACHE; --댓글번호
CREATE SEQUENCE SEQ_BOARD_CODE NOCACHE; --게시판종류코드번호
...
INSERT INTO "MEMBER" 
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '이번유저', '01098765432',
...
-- 회원정보 수정 메서드
UPDATE "MEMBER" SET
MEMBER_NICKNAME='' AND MEMBER_TEL='' AND MEMBER_ADDRESS =''
WHERE MEMBER_NO = ;
...
-- 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW='$2a$10$cmaPdylDhwMfHPVlfKCtDu8Qt4/TiU6tryfzlfoboYvYeCTjvO/0u';
